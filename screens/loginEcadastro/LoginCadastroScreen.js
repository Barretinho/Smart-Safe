    ...
    >
      <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
        <View style={styles.ContainerLogo}>
          <Image
            source={require("../../src/assets/Logo-SmartSafe2.png")}
            style={styles.logo}
          ></Image>
        </View>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.descriptionScrollView}>
              <Text style={styles.modalDescription}>
                ...
                adipiscing elit.{"\n"}• Vivamus euismod odio a arcu dictum, nec
                vehicula ipsum sodales.{"\n"}• Donec vitae luctus quam, ac
                eleifend orci.{"\n"}• Fusce non tortor est. Mauris varius tortor
                sed interdum aliquet.{"\n"}• Phasellus in metus sed urna
                ullamcorper vestibulum.{"\n"}• Nulla a velit pretium, aliquam
                velit eu, dignissim felis.{"\n"}• Quisque ut dictum libero.
                Donec scelerisque placerat ligula, in eleifend tortor interdum
                et.{"\n"}• Donec ullamcorper nulla non tempor facilisis.{"\n"}•
                In hac habitasse platea dictumst. Nullam ac luctus felis, at
                consectetur lacus.{"\n"}• Cras euismod risus vel arcu blandit,
                nec vestibulum enim finibus.{"\n"}• Nulla sagittis rutrum magna,
                at sodales justo feugiat sed.{"\n"}
              </Text>
            </ScrollView>
